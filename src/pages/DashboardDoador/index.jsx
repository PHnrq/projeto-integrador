            ...
            <main className="content">
                <div className="container">
                    <div className="div">
                        <div className="box-1">
                            ...
                            <div className="products">
                                <div className="registered-products">
                                    ...
                                    <p className="registered-products__view-all">
                                        Ver todos.
                                    </p>
                                </div>
                                <div className="aliments">
                                    <div className="aliment">
                                        <div className="aliment__div">
                                            <img src= {arrozBranco}  alt="Arroz branco" className="aliment__image"/>
                                        ...
                                        <div className="aliment__quantity-div">
                                            <span className="aliment__quantity">
                                                QTD
                                            </span>
                                    ...
                                    <div className="aliment">
                                        <div className="aliment__div">
                                            <img src= {acucarCristal}   alt="Arroz branco" className="aliment__image"/>
                                            <p className="aliment__validity">VAL: 13 / 08 / 22 </p>
                                        </div>
                                    ...
                                    <div className="aliment">
                                        <div className="aliment__div">
                                            <img src= {feijaoKicaldo}   alt="Arroz branco" className="aliment__image"/>
                                            <p className="aliment__validity">VAL: 13 / 08 / 22 </p>
                                        </div>
                        ...
                        <button className="btn-add-to-card"> <img className="icon-btn"src= {iconBtn} alt=""/> Adicionar Produtos</button>
                    </div>
                    <div className="div-2">
                        <div className="box-2">
                            ...
                            <div className="order">
                                ...
                                <p className="order__ong-name">
                                    ONG Criança Feliz
                                </p>
                                <div className="order__date">
                                    <p className="order__date__p">
                                        Data de retirada:
                                    </p>
                                    <p className="order__date__number">
                                        27/07/2023
                                        
                                    </p>
                                </div>
                                <div className="order__aliments">
                                    <img className="order__button-left" src="assets/images/button-left.svg" alt=""/>
                                    <div className="order__aliment">
                                        <img className="order__aliment__image" src={arrozBranco} alt=""/>
                                    ...
                                    <div className="order__aliment">
                                        <img className="order__aliment__image" src= {macarrao} alt=""/>
                                    ...
                                    <div className="order__aliment">
                                        <img className="order__aliment__image" src= {massaDonaBenta} alt=""/>
                                    ...
                                    <img className= "order__button-rigth"src= {btnRigth} alt srcset/>
                                </div>
                            </div>              
                        </div>
                    </div>
